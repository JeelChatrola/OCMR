...
class PidVelocity():
    ...
    def __init__(self):
        ...
        rospy.Subscriber("encoder_R", Int64, self.wheelCallback) 
        rospy.Subscriber("wheel_vtarget_R", Float32, self.targetCallback) 
        self.pub_motor = rospy.Publisher('pwm_R',Int16, queue_size=10) 
